...
const tutorials = [
  ...
  },
  {
    ...
    items: [
      {
        title: 'Quickstart — API Key & erster Check',
        desc: 'Account erstellen, API Key generieren, Rate Limit konfigurieren und erste API in 5 Minuten schützen.',
        duration: '5 Min', level: 'Einsteiger',
        path: '/developers/tutorials/ratelimit-quickstart',
        tags: ['curl', 'JavaScript', 'Setup'],
      },
      {
        title: 'Rate-Limiting in Express.js einrichten',
        desc: 'RateLimit API als Express Middleware — endpoint-spezifische Limits, Fail-open-Pattern und Next.js App Router.',
        duration: '10 Min', level: 'Einsteiger',
        path: '/developers/tutorials/ratelimit-express',
        tags: ['Express', 'Node.js', 'Next.js'],
      },
      {
        title: 'IP-Blacklisting & Abuse-Prevention',
        desc: 'IP-Blacklists, Whitelists und User-Agent-Filter anlegen — inkl. Client-IP korrekt durchreichen.',
        duration: '15 Min', level: 'Fortgeschritten',
        path: '/developers/tutorials/ratelimit-blacklist',
        tags: ['Security', 'IP-Filter', 'Dashboard'],
      },
      {
        title: 'Analytics-Dashboard auslesen',
        desc: 'Request-Logs, Top-IPs, Zeitverlauf und Blockierungsrate verstehen und mit eigenem Monitoring kombinieren.',
        duration: '15 Min', level: 'Fortgeschritten',
        path: '/developers/tutorials/ratelimit-analytics',
        tags: ['Analytics', 'Monitoring', 'Dashboard'],
      },
      {
        title: 'Vollständige API-Referenz',
        desc: 'Alle Endpunkte: Auth, /check, API Keys, Filter-Regeln, Analytics und Logs dokumentiert.',
        duration: 'Referenz', level: 'Referenz',
        path: '/developers/tutorials/ratelimit-api',
        tags: ['API', 'REST', 'Referenz'],
      },
    ],
  },
  {
    ...
    items: [
      {
        title: 'Quickstart — Erstes Modell trainieren',
        desc: 'Installation, HuggingFace-Modell importieren, Datensatz laden und erstes LoRA Fine-Tuning starten.',
        duration: '30 Min', level: 'Einsteiger',
        path: '/developers/tutorials/frametrain-quickstart',
        tags: ['FrameTrain', 'HuggingFace', 'LoRA'],
      },
      {
        title: 'LoRA Fine-Tuning — Deep Dive',
        desc: 'Rank, Alpha, Target Modules und QLoRA verstehen — mit Konfigurations-Beispielen für 8 GB und Apple M2.',
        duration: '20 Min', level: 'Fortgeschritten',
        path: '/developers/tutorials/frametrain-lora',
        tags: ['LoRA', 'QLoRA', 'Hyperparameter'],
      },
      {
        title: 'Datensätze aufbereiten',
        desc: 'CSV, JSON, JSONL und Instruction-Formate — Daten bereinigen, Größe planen und HuggingFace Datasets nutzen.',
        duration: '15 Min', level: 'Einsteiger',
        path: '/developers/tutorials/frametrain-dataset',
        tags: ['Dataset', 'JSONL', 'Python'],
      },
      {
        title: 'Modell exportieren und einbinden',
        desc: 'SafeTensors, GGUF oder PyTorch exportieren, per HuggingFace Transformers, Ollama oder FastAPI nutzen.',
        duration: '15 Min', level: 'Fortgeschritten',
        path: '/developers/tutorials/frametrain-export',
        tags: ['Export', 'GGUF', 'Ollama', 'FastAPI'],
      },
    ],
  },
];
