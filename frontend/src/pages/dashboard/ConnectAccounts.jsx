...
const products = [
  ...
  { id: 'frametrain',    name: 'FrameTrain',       description: 'KI-Modelle lokal trainieren',  icon: <Brain className="w-7 h-7" />,    color: 'from-violet-500 to-pink-500',  status: 'Live',  connectMode: 'sso',    ssoUrl: 'https://frame-train.com/api/auth/framesphere' },
