        ...
        <div className="card">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg border border-gray-700 bg-dark-800 hover:bg-dark-700 text-white font-medium transition-colors"
            >
              <GoogleIcon />
              Mit Google anmelden
            </button>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 bg-dark-800 text-gray-500">oder mit E-Mail</span>
            </div>
          </div>
